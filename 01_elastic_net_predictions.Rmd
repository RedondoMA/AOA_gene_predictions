...
When Using R studio >4.3, as of 29-August-2023, there is a bug with the sort() command that gives an error on the phyEstimateDisc function. To avoid that error, run the muted line 219 instead of line 217
...
#If working with R >4.2 and the loop stops run the muted line below intead of the one above
#pic_pred<-phyEstimateDisc_mine(tree_AOA_asr2,traits_AOA3[,i,drop=FALSE])
