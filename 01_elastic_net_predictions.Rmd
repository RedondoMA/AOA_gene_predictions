...
source("./functions/pred_phyl_glmnet_evo.R")#Fitting "a" parameter in PEMs for each trait
...
n_runs=20#I leave 1 for the script to run fast. Change to desired number of runs
